...
import { server, useDeleteProductMutation, useProductDetailsQuery, useUpdateProductMutation } from "../../../redux/api/ProductApi";
...
const Productmanagement = () => {
  ...
  const { price, stock, name, photos, category, _id } = products
  ...
  const submitHandler = async(e: FormEvent<HTMLFormElement>) => {
    ...
    if (categoryUpdate) formData.set("catefory", categoryUpdate)
    
    const res = await updateProduct({userId:user._id, productId:_id, formData:formData})
